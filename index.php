		...
		<div class="col s6 offset-s3 auth">
				...
				<div class ="card-panel z-depth-3">
					<ul class="tabs tabs-fixed-width blue">
        				<li class="tab col s3 "><a class="signin" href="#signin"> <span class="white-text ">Se connecter</span></a></li>
        				<li class="tab col s3 "><a class="signup" href="#signup"> <span class="white-text ">S'inscrire</span></a></li>
      				</ul>
    					...
    					<div id="signup" >
    						...
    						<button type="submit" name="signup" class="btn brown lighten-1 waves-effect waves-light">S'inscrire</button>
    						</form>
      				    </div>
				</div>
